jQuery(function ($) {
	...
	//section vidéos slide pour page vidéos
	$('.expect-videos').owlCarousel({
		loop: true,
		nav: true,
		dots: false,
		margin: 25,
	...
	// Count Time 
	function makeTimer() {
		var endTime = new Date("December 10, 2022 09:00:00 PDT");			
		var endTime = (Date.parse(endTime)) / 1000;
		var now = new Date();
		var now = (Date.parse(now) / 1000);
		var timeLeft = endTime - now;
	...
	// Buy Now Btn
	$('body').append("<a href='https://chat.whatsapp.com/EKWfZcG14Lb3RdKRu16QC2' target='_blank' class='buy-now-btn'> <i class='bx bxl-whatsapp'></i></a>");
